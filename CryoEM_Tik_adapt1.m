function [unew,alpha,OutPut] = CryoEM_Tik_adapt1(T,b,eta,eta0,A,utrue,g)

if nargin == 7, alpha = 1e-5;  u = 0 * b;  end
...
[unew, be,OutPut] = NewtonTikDPRegParam1(T,b,eta,eta0,u,beta,A,utrue,g);
