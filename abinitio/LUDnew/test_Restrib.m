...
load cleanrib;
fname = 'cleanribw';
% volref = ReadMRC('emd_2834.map');
% fname = 'emd_2834';
figure;isosurface(real(volref),max(real(volref(:)))/6);axis off;%axis vis3d tight;
title('OR');
%  print('-djpeg',strcat('.././figsph/vol',fname,'ORG.jpg'));
 
% print('-djpeg',strcat('/home/panh/panhuan/aspirev013org/aspirev013org/abinitio/C1/LUD_new/figsph/vol',fname,'ORG.jpg'));
fp = fopen('test_Rest_rib.txt','a+');
...
for K = [500, 1000, 2000]
for SNR = [1, 1/2, 1/4,1/8,1/16,1/32]
    %SNR=1000; % No noise
...
%      print('-djpeg',strcat('./figsph/vol',fname,num2str(K),num2str(1./SNR),'PGMp2q2.jpg'));
...
%     print('-djpeg',strcat('./figsph/vol',fname,num2str(K),num2str(1./SNR),'PGMp2q1.jpg'));
    ...
    %axis vis3d tight;
%     print('-djpeg',strcat('./figsph/vol',fname,num2str(K),num2str(1./SNR),'MPGMp2q2.jpg'));
    ...
    %axis vis3d tight;
%     print('-djpeg',strcat('./figsph/vol',fname,num2str(K),num2str(1./SNR),'MPGMp2q1.jpg'));
...
%     print('-djpeg',strcat('./figsph/vol',fname,num2str(K),num2str(1./SNR),'LS.jpg'));
...
%     print('-djpeg',strcat('./figsph/vol',fname,num2str(K),num2str(1./SNR),'LUD.jpg'));
...
%     print('-djpeg',strcat('./figsph/vol',fname,num2str(K),num2str(1./SNR),'IRLS.jpg'));
